 ...
 *  Page auth two steps
 */
function loadAuthTwoSteps() {
    'use strict';

    const formEmailValidation = document.querySelector('#formEmailValidation');
    if (formEmailValidation) {
        const fv = FormValidation.formValidation(formEmailValidation, {
            fields: {
                email: {
                    validators: {
                        notEmpty: {
