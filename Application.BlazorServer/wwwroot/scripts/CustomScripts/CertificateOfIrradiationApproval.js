...
//        filterSchedule(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))
//    });
//})
...
function filterSchedule(start, end) {
    dotnetInstance.invokeMethodAsync('FilterSchedule', start, end)
        .then(data => {
            console.log(data);
        });
}
